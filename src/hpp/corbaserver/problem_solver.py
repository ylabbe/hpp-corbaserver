...
class ProblemSolver(object):
    ...
    def loadObstacleFromUrdf(self, package, filename, prefix):
        return self.hppcorba.obstacle.loadObstacleModel(
    ...
    #  Constraints are stored in ProblemSolver object
    def createRelativeComConstraint(self, constraintName, comName, jointLName,
                                    point, mask):
    ...
    #  Constraints are stored in ProblemSolver object
    def createComBeetweenFeet(self, constraintName, comName, jointLName,
                              jointRName, pointL, pointR, jointRefName, mask):
    ...
    #  the global frame.
    #  constraints are stored in ProblemSolver object
    def createPositionConstraint(self, constraintName, joint1Name, joint2Name,
                                 point1, point2, mask):
    ...
    def setRightHandSideByName(self, constraintName, rhs):
        return self.hppcorba.problem.setRightHandSideByName(
            constraintName, rhs)
    ...
    def selectPathValidation(self, pathValidationType, tolerance):
        return self.hppcorba.problem.selectPathValidation(
    ...
    def selectPathProjector(self, pathProjectorType, tolerance):
        return self.hppcorba.problem.selectPathProjector(
    ...
    def directPath(self, startConfig, endConfig, validate):
        return self.hppcorba.problem.directPath(startConfig, endConfig,
                                                validate)
    ...
    def getNearestConfig(self, randomConfig, connectedComponentId=-1):
        return self.hppcorba.problem.getNearestConfig(randomConfig,
    ...
    def addEdgeToRoadmap(self, config1, config2, pathId, bothEdges):
        return self.hppcorba.problem.addEdgeToRoadmap(config1, config2, pathId,
                                                      bothEdges)
